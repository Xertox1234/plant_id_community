/**
 * StreamFieldEditor Component
 *
 * Visual editor for creating and editing StreamField-compatible care instructions.
 * Supports all block types: heading, paragraph, treatment_step, symptom_check,
