...
description: Reviews Firebase-related Flutter files and backend token-exchange code: auth, Firestore listeners, secure storage, GDPR redaction. Dispatched for firebase/auth/Firestore-touching changes.
model: sonnet
color: yellow
