...
- [x] #H13 llm-spam-prescreen → todo 255 (completed 2026-07-21); pre-enable
      hardening → todo 274 (completed 2026-07-25); env enable → todo 280
      (completed 2026-09-03 — live in production)
