    ...
    try:
        ...
        if result:
            ...
            if suggestions:
                ...
                print(
                    f"   Top suggestion: {top_suggestion.get('scientific_name', 'Unknown')}"
                )
                ...
                if result.get("results"):
                    ...
                    print(
                        f"   Raw result: {species.get('scientificNameWithoutAuthor', 'Unknown')} (score: {first_result.get('score', 0):.3f})"
                    )
