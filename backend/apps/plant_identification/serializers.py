    ...
    def validate(self, data):
        ...
        if not data.get("image_1"):
            raise serializers.ValidationError(
                "At least one symptom image is required for disease diagnosis."
            )

        if not data.get("symptoms_description"):
            raise serializers.ValidationError(
                "Please describe the symptoms you're observing."
            )
...
class PlantDiseaseResultSerializer(serializers.ModelSerializer):
    ...
    diagnosed_by_username = serializers.CharField(
        source="diagnosed_by.username", read_only=True
    )
    display_name = serializers.ReadOnlyField()
...
class PlantIdentificationResultSerializer(serializers.ModelSerializer):
    ...
    identified_species_data = PlantSpeciesSerializer(
        source="identified_species", read_only=True
    )
    identified_by_username = serializers.CharField(
    ...
    class Meta:
        ...
        fields = [
            ...
            "updated_at",
            "display_name",
            "ai_care_instructions",
            "care_instructions_generated_at",
            "user_vote",
        ]
...
class UserPlantSerializer(serializers.ModelSerializer):
    ...
    from_identification_request_id = serializers.CharField(
        source="from_identification_request.request_id", read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            "is_alive",
            "is_public",
            "from_identification_request",
            "from_identification_request_id",
            "from_identification_result",
...
class PlantIdentificationRequestWithResultsSerializer(serializers.ModelSerializer):
    ...
    image_thumbnails = serializers.SerializerMethodField()
    results_count = serializers.SerializerMethodField()
    identification_results = PlantIdentificationResultSerializer(
