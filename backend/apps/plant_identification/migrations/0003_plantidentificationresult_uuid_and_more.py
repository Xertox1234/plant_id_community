    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "treatment_name",
                    models.CharField(
                        help_text="Name of the treatment method", max_length=200
                    ),
                ),
                (
                    "treatment_type",
                ...
                (
                    "instructions",
                    models.TextField(help_text="Detailed treatment instructions"),
                ),
                (
                    "application_timing",
                    models.TextField(
            ...
            fields=[
                ...
                (
                    ...
                    imagekit.models.fields.ProcessedImageField(
                        ...
                        validators=[
                            apps.core.validators.validate_plant_identification_image
                        ],
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="diagnosis_results",
                        to="plant_identification.plantdiseaserequest",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "started_date",
                    models.DateField(help_text="Date when treatment was started"),
                ),
                (
                    "completed_date",
                    models.DateField(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="plant_identification.saveddiagnosis",
                    ),
                ),
                (
                    "treatment",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="plant_identification.diseasecareinstructions",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="plant_identification.TreatmentAttempt",
                to="plant_identification.diseasecareinstructions",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-created_at"], name="plant_ident_created_c092f0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantdiseaserequest",
            index=models.Index(
                fields=["user", "-created_at"], name="plant_ident_user_id_47ba4e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantdiseaserequest",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="plant_ident_request_cf3717_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="plantdiseaseresult",
            index=models.Index(
                fields=["identified_disease"], name="plant_ident_identif_219a2f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantdiseaseresult",
            index=models.Index(
                fields=["-created_at"], name="plant_ident_created_578abb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantdiseaseresult",
            index=models.Index(
                fields=["confidence_score"], name="plant_ident_confide_a15a14_idx"
            ),
        ),
