...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When AI processing started", null=True
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="plant_identification.batchidentificationrequest",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-created_at"], name="plant_ident_created_a20aa9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchidentificationrequest",
            index=models.Index(
                fields=["user", "-created_at"], name="plant_ident_user_id_c95e43_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchidentificationrequest",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["batch_request", "upload_order"],
                name="plant_ident_batch_r_4501cb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="batchidentificationimage",
            index=models.Index(
                fields=["processing_status"], name="plant_ident_process_a001a5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchidentificationcomparison",
            index=models.Index(
                fields=["batch_request", "-created_at"],
                name="plant_ident_batch_r_447a06_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="batchidentificationcomparison",
            index=models.Index(
                fields=["action_taken"], name="plant_ident_action__bd80b4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchprocessingqueue",
            index=models.Index(
                fields=["status", "priority"], name="plant_ident_status_c261be_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchprocessingqueue",
            index=models.Index(
                fields=["queue_position"], name="plant_ident_queue_p_8c2639_idx"
            ),
        ),
    ]
