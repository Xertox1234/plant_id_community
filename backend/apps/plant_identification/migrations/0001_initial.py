...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "family",
                    models.CharField(
                        blank=True, help_text="Plant family name", max_length=100
                    ),
                ),
                (
                    "genus",
                    models.CharField(
                        blank=True, help_text="Plant genus", max_length=100
                    ),
                ),
                (
                    "species",
                    models.CharField(
                        blank=True, help_text="Species name", max_length=100
                    ),
                ),
                (
                    "trefle_id",
                ...
                (
                    "soil_ph_min",
                    models.FloatField(
                        blank=True, help_text="Minimum soil pH tolerance", null=True
                    ),
                ),
                (
                    "soil_ph_max",
                    models.FloatField(
                        blank=True, help_text="Maximum soil pH tolerance", null=True
                    ),
                ),
                (
                    "hardiness_zone_min",
                    models.IntegerField(
                        blank=True, help_text="Minimum USDA hardiness zone", null=True
                    ),
                ),
                (
                    "hardiness_zone_max",
                    models.IntegerField(
                        blank=True, help_text="Maximum USDA hardiness zone", null=True
                    ),
                ),
                (
                    "description",
                ...
                (
                    "flower_color",
                    models.CharField(
                        blank=True, help_text="Typical flower colors", max_length=100
                    ),
                ),
                (
                    "primary_image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, help_text="Suggested common name", max_length=200
                    ),
                ),
                (
                    "confidence_score",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="plant_identification.plantidentificationrequest",
                    ),
                ),
                (
                    "identified_species",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "acquisition_date",
                    models.DateField(
                        blank=True, help_text="When did you get this plant?", null=True
                    ),
                ),
                (
                    "location_in_home",
                ...
                (
                    "is_alive",
                    models.BooleanField(
                        default=True, help_text="Is this plant still alive?"
                    ),
                ),
                (
                    "is_public",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-created_at"], name="plant_ident_created_539451_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantidentificationrequest",
            index=models.Index(
                fields=["user", "-created_at"], name="plant_ident_user_id_305bb3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantidentificationrequest",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="plant_ident_request_fa9918_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="plantidentificationresult",
            index=models.Index(
                fields=["identified_species"], name="plant_ident_identif_903f8c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plantidentificationresult",
            index=models.Index(
                fields=["-created_at"], name="plant_ident_created_d45176_idx"
            ),
        ),
