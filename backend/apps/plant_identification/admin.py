...
class PlantSpeciesAdmin(admin.ModelAdmin):
    ...
    search_fields = ("scientific_name", "common_names", "family", "genus", "species")
    ...
    fieldsets = (
        ...
        (
            "External IDs",
            {"fields": ("trefle_id", "plantnet_id"), "classes": ("collapse",)},
        ),
        (
            "Characteristics",
            {
        ...
        ("Description", {"fields": ("description", "native_regions")}),
        ("Images", {"fields": ("primary_image", "primary_image_display")}),
        ("Verification", {"fields": ("is_verified", "verification_source")}),
...
class PlantIdentificationRequestAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "processed_by_ai", "plant_size", "created_at")

    search_fields = ("request_id", "user__username", "description", "location")
    ...
    fieldsets = (
        ("Request Info", {"fields": ("request_id", "user", "status")}),
        (
            "Images",
            {
                "fields": (
        ...
        (
            "Location & Context",
            {"fields": ("location", "latitude", "longitude", "habitat")},
        ),
        ("Plant Description", {"fields": ("description", "plant_size")}),
        (
            "Processing",
            {
                "fields": (
...
class PlantIdentificationResultAdmin(admin.ModelAdmin):
    ...
    list_filter = ("identification_source", "is_accepted", "is_primary", "created_at")

    search_fields = (
        "request__request_id",
        "identified_species__scientific_name",
    ...
    fieldsets = (
        ...
        ("Source", {"fields": ("identification_source", "identified_by")}),
        (
            "Community Voting",
            {"fields": ("upvotes", "downvotes", "vote_score_display")},
        ),
        ("Status", {"fields": ("is_accepted", "is_primary")}),
        (
            "Additional Info",
            {"fields": ("notes", "api_response_data"), "classes": ("collapse",)},
        ),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class UserPlantAdmin(admin.ModelAdmin):
    ...
    list_filter = ("is_alive", "is_public", "created_at")
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("user", "collection", "species", "nickname")}),
        ("Care Details", {"fields": ("acquisition_date", "location_in_home", "notes")}),
        ("Status", {"fields": ("is_alive", "is_public")}),
        ("Image", {"fields": ("image", "image_display")}),
        ("Tracking", {"fields": ("from_identification_request",)}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
