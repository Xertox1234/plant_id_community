...
class AIBotanicalImageService:
    ...
    def generate_plant_image(
        ...
        max_daily_cost = getattr(
            settings, "AI_IMAGE_DAILY_COST_LIMIT", 5.0
        )  # $5 default
    ...
    def download_and_create_wagtail_image(
        self, image_data: Dict, title_prefix: str = "AI Generated Plant Image"
    ) -> Optional[Image]:
        """
        ...
        try:
            ...
            try:
                ...
                if image_data.get("scientific_name"):
                    tags.append(
                        f"scientific:{image_data['scientific_name'].replace(' ', '_')}"
                    )
    ...
    def get_best_ai_plant_image(
        ...
        wagtail_image = self.download_and_create_wagtail_image(
            image_data, title_prefix=f"AI {plant_name} Plant"
        )
    ...
    def get_generation_stats(self) -> Dict:
        ...
        return {
            ...
            "remaining_budget": max(
                0,
                getattr(settings, "AI_IMAGE_DAILY_COST_LIMIT", 5.0)
                - self.get_daily_cost(),
            ),
