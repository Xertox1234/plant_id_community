            ...
            "data": {
                ...
                "main_species": {
                    "specifications": {
                        ...
                        "seed": {"seed_color": ["brown"], "shape": "oval"},
                    },
                    "growth": {
                        "atmospheric_humidity": 60,
                        "growth_months": ["March", "April", "May"],
                        "light": 7,
                        "minimum_temperature": {"deg_c": 5, "deg_f": 41},
                    },
                },
            }
        }
    ...
    def test_diagnose_disease_success(self, mock_post):
        ...
        mock_response.json.return_value = {
            "health_assessment": {
                ...
                "is_plant": {"probability": 0.99, "threshold": 0.5},
            },
            "modifiers": [],
            "language": "en",
            "datetime": 1234567890,
        ...
        result = self.service.diagnose_disease(
            [self.diseased_image], "Rose with black spots"
        )
...
class TestServiceIntegration(TestCase):
    ...
    @pytest.mark.integration
    @patch(
        "apps.plant_identification.services.plant_health_service.PlantHealthAPIService.diagnose_disease"
    )
