...
router.register(
    r"disease-results", views.PlantDiseaseResultViewSet, basename="disease-results"
)
router.register(
    r"disease-database", views.PlantDiseaseDatabaseViewSet, basename="disease-database"
)
router.register(
    r"saved-diagnoses", views.SavedDiagnosisViewSet, basename="saved-diagnoses"
)
router.register(
    r"saved-care-instructions",
    views.SavedCareInstructionsViewSet,
    basename="saved-care-instructions",
)
router.register(
    r"treatment-attempts", views.TreatmentAttemptViewSet, basename="treatment-attempts"
)
...
urlpatterns = [
    ...
    path(
        "care-instructions/",
        views.get_care_instructions,
        name="care_instructions_by_name",
    ),
    path(
        "care-instructions/<int:species_id>/",
        views.get_care_instructions,
        name="care_instructions",
    ),
    path(
        "results/<int:result_id>/regenerate-care/",
        views.regenerate_care_instructions,
        name="regenerate_care_instructions",
    ),
    ...
    path(
        "species/<int:species_id>/characteristics/",
        views.get_plant_characteristics,
        name="plant_characteristics",
    ),
    path(
        "species/<int:species_id>/growth-info/",
        views.get_plant_growth_info,
        name="plant_growth_info",
    ),
