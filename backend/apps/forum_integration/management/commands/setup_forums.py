...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Forum setup failed: {str(e)}"))
    ...
    def clear_existing_data(self):
        ...
        self.stdout.write(self.style.WARNING("Existing forum data cleared."))
    ...
    def create_wagtail_pages(self):
        ...
        forum_index.content_blocks = [
            {"type": "heading", "value": "Welcome to Our Plant Community!"},
            {
                "type": "paragraph",
        ...
        for slug, forum in self.created_forums.items():
            ...
            ForumPageMapping.objects.create(
                wagtail_page=category_page, machina_forum=forum, is_active=True
            )
        ...
        moderation_page.content_blocks = [
            {"type": "heading", "value": "Moderation Dashboard"},
            {
                "type": "paragraph",
    ...
    def get_category_content_blocks(self, slug, forum):
        ...
        content_blocks = [
            {"type": "heading", "value": forum.name},
            {"type": "paragraph", "value": f"<p>{forum.description}</p>"},
        ]
    ...
    def create_sample_data(self, admin_username):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Created {len(created_topics)} sample topics with replies."
            )
        )
    ...
    def setup_permissions(self):
        ...
        self.stdout.write(self.style.SUCCESS("Forum permissions configured."))
