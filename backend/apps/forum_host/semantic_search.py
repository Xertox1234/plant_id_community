...
class SemanticSearchMixin:
    ...
    @extend_schema(
        ...
        description=(
            ...
            "1-based, capped at MAX_PAGE), semantic (optional; '1' opts into "
            "the premium semantic section). Each section returns up to "
            "PAGE_SIZE results plus a *_has_more flag — no silent cap; page "
            "through with ?page=. Offset-paged over relevance-ranked results, "
            "so a concurrent topic/post write can shift the window; clients "
