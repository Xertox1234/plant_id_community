    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        ...
                        blank=True,
                        block_lookup={
                            0: ("wagtail.blocks.URLBlock", (), {"icon": "link"})
                        },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "introduction",
                    wagtail.fields.RichTextField(
                        blank=True, help_text="Introduction text for the blog"
                    ),
                ),
                (
                    "posts_per_page",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        blank=True, help_text="Subscriber first name", max_length=100
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Is subscription active?"
                    ),
                ),
                (
                    "frequency",
                ...
                (
                    "source",
                    models.CharField(
                        blank=True, help_text="How did they find us?", max_length=100
                    ),
                ),
                (
                    "ip_address",
                    models.GenericIPAddressField(
                        blank=True, help_text="IP address when subscribed", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "publish_date",
                    models.DateField(help_text="Date to publish this post"),
                ),
                (
                    "introduction",
                    wagtail.fields.RichTextField(
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            17: (
                                ...
                                (16,),
                                {"max_num": 12, "min_num": 2},
                            ),
                            18: (
                                "wagtail.blocks.StructBlock",
                                [[("gallery_title", 10), ("images", 17)]],
                                {
                                    "icon": "image",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, help_text="Order within the series", null=True
                    ),
                ),
                (
                    "is_featured",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="blog_blogco_post_id_9d37d4_idx",
                    ),
                    models.Index(
                        fields=["author", "created_at"],
                        name="blog_blogco_author__1614fe_idx",
                    ),
                    models.Index(
