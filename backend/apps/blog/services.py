"""
Blog services for intelligent content population and plant data integration.

This module provides services for auto-populating blog block fields with
plant data from local database, external APIs, and AI generation.
"""
