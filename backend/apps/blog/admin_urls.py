...
urlpatterns = [
    ...
    path(
        "comments/approve/<int:comment_id>/",
        admin_views.approve_comment,
        name="approve_comment",
    ),
    path(
        "comments/reject/<int:comment_id>/",
        admin_views.reject_comment,
        name="reject_comment",
    ),
    # Featured posts management
    path("featured/", admin_views.featured_posts, name="featured_posts"),
    path(
        "posts/<int:post_id>/toggle-featured/",
        admin_views.toggle_featured,
        name="toggle_featured",
    ),
    # Post-specific management
    path(
        "posts/<int:post_id>/comments/", admin_views.post_comments, name="post_comments"
    ),
    path(
        "posts/<int:post_id>/ai-suggestions/",
        admin_views.ai_content_suggestions,
        name="post_ai_suggestions",
    ),
    path("posts/<int:post_id>/tag-plants/", admin_views.tag_plants, name="tag_plants"),
    path(
        "posts/<int:post_id>/feature/", admin_views.toggle_featured, name="feature_post"
    ),
    path(
        "posts/<int:post_id>/unfeature/",
        admin_views.toggle_featured,
        name="unfeature_post",
    ),
    ...
    path(
        ...
        api_views.PlantSuggestionsView.as_view(),
        name="plant_suggestions",
    ),
    # Search
