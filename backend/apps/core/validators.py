        ...
        try:
            ...
            with Image.open(file) as img:
                ...
                with Image.open(file) as img2:
                    ...
                    if (
                        width < MIN_IMAGE_DIMENSIONS[0]
                        or height < MIN_IMAGE_DIMENSIONS[1]
                    ):
                        raise ValidationError(
                    ...
                    if (
                        width > MAX_IMAGE_DIMENSIONS[0]
                        or height > MAX_IMAGE_DIMENSIONS[1]
                    ):
                        raise ValidationError(
...
class SecurityLogger:
    ...
    def log_file_upload_attempt(
        user, filename: str, file_size: int, success: bool, error: str = None
    ):
