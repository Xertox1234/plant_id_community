        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template_name",
                    models.CharField(
                        help_text="Template used for email", max_length=100
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["email_type"], name="core_emailn_email_t_2441d9_idx"
                    ),
                    models.Index(
                        fields=["recipient_email"],
                        name="core_emailn_recipie_f03923_idx",
                    ),
                    models.Index(
                        fields=["status"], name="core_emailn_status_5434fd_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="core_emailn_created_c136a1_idx"
                    ),
                    models.Index(
                        fields=["user", "-created_at"],
                        name="core_emailn_user_id_91c496_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="core_forumn_user_id_aedbee_idx",
                    ),
                    models.Index(
                        fields=["notification_type", "frequency"],
                        name="core_forumn_notific_11b2d8_idx",
                    ),
                ],
                "unique_together": {
                    ("user", "notification_type", "topic_id", "forum_id")
                },
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "is_read"],
                        name="core_inappn_user_id_1cbb59_idx",
                    ),
                    models.Index(
                        fields=["category"], name="core_inappn_categor_d0a7a1_idx"
                    ),
                    models.Index(
                        fields=["-created_at"], name="core_inappn_created_8ba56d_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "plant_name",
                    models.CharField(
                        help_text="Name of the plant for this reminder", max_length=200
                    ),
                ),
                (
                ...
                (
                    "next_reminder_date",
                    models.DateTimeField(help_text="When to send the next reminder"),
                ),
                (
                    "last_sent_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "is_active"],
                        name="core_plantc_user_id_a28d0f_idx",
                    ),
                    models.Index(
                        fields=["next_reminder_date", "is_active"],
                        name="core_plantc_next_re_c88157_idx",
                    ),
                    models.Index(
                        fields=["care_type"], name="core_plantc_care_ty_e61e0c_idx"
                    ),
                ],
            },
        ),
