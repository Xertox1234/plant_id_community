...
class PlantCareReminder(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="plant_care_reminders"
    )
    ...
    plant_name = models.CharField(
        max_length=200, help_text="Name of the plant for this reminder"
    )

    plant_scientific_name = models.CharField(
        max_length=200, blank=True, help_text="Scientific name of the plant"
    )
    ...
    custom_instructions = models.TextField(
        blank=True, help_text="Custom care instructions for this reminder"
    )

    # Scheduling
    is_active = models.BooleanField(
        default=True, help_text="Whether this reminder is active"
    )
    ...
    reminder_count = models.PositiveIntegerField(
        default=0, help_text="Number of reminders sent"
    )
    ...
    def mark_reminder_sent(self):
        ...
        self.save(
            update_fields=["last_sent_at", "reminder_count", "next_reminder_date"]
        )
