...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            ...
            "0011_batchidentificationrequest_batchidentificationimage_and_more",
        ),
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="plant_identification.savedcareinstructions",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Title/name for this demo data item", max_length=200
                    ),
                ),
                (
                    "description",
                ...
                (
                    "data_content",
                    models.JSONField(help_text="The actual demo data content as JSON"),
                ),
                (
                    "display_order",
                    models.PositiveIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "page_url",
                    models.URLField(
                        blank=True, help_text="URL where the action occurred"
                    ),
                ),
                (
                    "user_agent",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "is_active"], name="users_carer_user_id_277b2f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="carereminder",
            index=models.Index(
                fields=["next_reminder_date", "is_active"],
                name="users_carer_next_re_2b563a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="carereminder",
            index=models.Index(
                fields=["reminder_type"], name="users_carer_reminde_64b263_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="carereminderlog",
            index=models.Index(
                fields=["reminder", "-created_at"],
                name="users_carer_reminde_09dc02_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="carereminderlog",
            index=models.Index(
                fields=["action", "-created_at"], name="users_carer_action_50409b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="demodata",
            index=models.Index(
                fields=["demo_type", "is_active"], name="users_demod_demo_ty_12e2e0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="demodata",
            index=models.Index(
                fields=["target_onboarding_step"], name="users_demod_target__89992b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="demodata",
            index=models.Index(
                ...
                name="users_demod_is_feat_98f624_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="onboardingprogress",
            index=models.Index(
                fields=["is_onboarding_active"], name="users_onboa_is_onbo_e45d9c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="onboardingprogress",
            index=models.Index(
                fields=["current_step"], name="users_onboa_current_97ae90_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="onboardingprogress",
            index=models.Index(
                ...
                name="users_onboa_onboard_f88c3f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="onboardinganalytics",
            index=models.Index(
                fields=["user", "-created_at"], name="users_onboa_user_id_8c6f57_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="onboardinganalytics",
            index=models.Index(
                ...
                name="users_onboa_action__80137c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="onboardinganalytics",
            index=models.Index(
                fields=["onboarding_progress", "-created_at"],
                name="users_onboa_onboard_6e5afe_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pushsubscription",
            index=models.Index(
                fields=["user", "is_active"], name="users_pushs_user_id_5271ce_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pushsubscription",
            index=models.Index(
                fields=["endpoint"], name="users_pushs_endpoin_e92940_idx"
            ),
        ),
