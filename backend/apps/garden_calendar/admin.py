...
class CommunityEventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Date & Time", {"fields": ("start_datetime", "end_datetime", "is_all_day")}),
        (
            "Location",
            {
                "fields": (
...
class SeasonalTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Location & Season", {"fields": ("hardiness_zones", "season", "plant_types")}),
        (
            "Timing",
        ...
        ("Content", {"fields": ("instructions", "tips")}),
        (
            "System Fields",
            {
...
class WeatherAlertAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Location", {"fields": ("zip_code", "city", "hardiness_zone")}),
        ("Timing", {"fields": ("start_datetime", "end_datetime", "expires_at")}),
        (
            "Weather Data",
            {
                "fields": (
...
class GardenBedAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Location & Climate",
            {"fields": ("location_name", "sun_exposure", "hardiness_zone")},
        ),
        ("Soil Information", {"fields": ("soil_type", "soil_ph")}),
        ("Layout Data", {"fields": ("layout_data",), "classes": ("collapse",)}),
        (
            "Statistics",
            {"fields": ("plant_count", "utilization_rate"), "classes": ("collapse",)},
        ),
        (
            "Notes & System",
            {
    ...
    def utilization_display(self, obj):
        ...
        if rate is not None:
            ...
            if percentage < 25:
                ...
                color = "blue"
            return format_html(
                '<span style="color: {};">{:d}%</span>', color, percentage
            )
        return "N/A"
...
class PlantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {"fields": ("position_x", "position_y"), "classes": ("collapse",)},
        ),
        ("Health & Growth", {"fields": ("health_status", "growth_stage")}),
        ("Status", {"fields": ("is_active", "removed_date", "removal_reason")}),
        (
            "Care Tasks",
            {"fields": ("pending_care_tasks_count",), "classes": ("collapse",)},
        ),
        (
            "Notes & System",
            {
...
class CareTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Completion", {"fields": ("completed", "completed_at", "completed_by")}),
        (
            "Skip Status",
            {
...
class CareLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ["content", "plant__common_name", "user__username", "activity_type"]
    readonly_fields = ["log_date"]

    fieldsets = (
        ("Log Information", {"fields": ("plant", "user", "activity_type", "content")}),
        (
            "Environmental Data",
            {"fields": ("temperature", "humidity"), "classes": ("collapse",)},
        ),
        ("Tags & Metadata", {"fields": ("tags", "log_date"), "classes": ("collapse",)}),
    )
...
class HarvestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Quality & Notes", {"fields": ("quality_rating", "notes")}),
        (
            "Statistics",
            {"fields": ("days_from_planting", "created_at"), "classes": ("collapse",)},
        ),
    )
