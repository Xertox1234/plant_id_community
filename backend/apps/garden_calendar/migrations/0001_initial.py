...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tips",
                    models.TextField(
                        blank=True, help_text="Additional tips and advice"
                    ),
                ),
                (
                    "priority",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zip_code",
                    models.CharField(
                        help_text="ZIP code this alert applies to", max_length=10
                    ),
                ),
                (
                    "city",
                    models.CharField(
                        blank=True, help_text="City name for display", max_length=100
                    ),
                ),
                (
                    "hardiness_zone",
                ...
                (
                    "title",
                    models.CharField(help_text="Alert title/headline", max_length=200),
                ),
                ...
                (
                    "start_datetime",
                    models.DateTimeField(help_text="When the weather condition starts"),
                ),
                (
                    "end_datetime",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Optional notes from the attendee"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="garden_calendar.communityevent",
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["zip_code", "is_active"], name="garden_cale_zip_cod_dbc1b9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="weatheralert",
            index=models.Index(
                ...
                name="garden_cale_start_d_5e7b21_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="weatheralert",
            index=models.Index(
                fields=["alert_type", "severity"], name="garden_cale_alert_t_aefd24_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="seasonaltemplate",
            index=models.Index(
                fields=["season", "start_month"], name="garden_cale_season_127445_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="seasonaltemplate",
            index=models.Index(
                fields=["task_type", "is_active"], name="garden_cale_task_ty_fa4977_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="communityevent",
            index=models.Index(
                fields=["start_datetime", "privacy_level"],
                name="garden_cale_start_d_431460_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="communityevent",
            index=models.Index(
                fields=["city", "hardiness_zone"], name="garden_cale_city_635b34_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="communityevent",
            index=models.Index(
                ...
                name="garden_cale_event_t_871d8c_idx",
            ),
        ),
