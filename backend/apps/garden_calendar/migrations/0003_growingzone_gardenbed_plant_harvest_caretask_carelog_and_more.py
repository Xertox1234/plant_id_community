...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "garden_calendar",
            "0002_rename_garden_cale_zip_cod_dbc1b9_idx_garden_cale_zip_cod_1eb673_idx_and_more",
        ),
        (
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of this garden bed", max_length=200
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, help_text="Length in inches", null=True
                    ),
                ),
                (
                    "width_inches",
                    models.PositiveIntegerField(
                        blank=True, help_text="Width in inches", null=True
                    ),
                ),
                (
                    "depth_inches",
                    models.PositiveIntegerField(
                        blank=True, help_text="Depth/height in inches", null=True
                    ),
                ),
                (
                    "layout_data",
                ...
                (
                    "hardiness_zone",
                    models.CharField(
                        blank=True, help_text="USDA Hardiness Zone", max_length=5
                    ),
                ),
                (
                    "soil_type",
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="General notes about this bed"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "common_name",
                    models.CharField(help_text="Common name of plant", max_length=200),
                ),
                (
                    "scientific_name",
                    models.CharField(
                ...
                (
                    "planted_date",
                    models.DateField(help_text="Date this plant was planted/sown"),
                ),
                (
                    "source",
                    models.CharField(
                ...
                (
                    "removed_date",
                    models.DateField(
                        blank=True, help_text="Date plant was removed/died", null=True
                    ),
                ),
                (
                    "removal_reason",
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="General notes about this plant"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(
                        decimal_places=2, help_text="Quantity harvested", max_digits=8
                    ),
                ),
                (
                    "unit",
                ...
                (
                    "notes",
                    models.TextField(blank=True, help_text="Notes about this harvest"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "plant",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Task title/description", max_length=200
                    ),
                ),
                (
                    "notes",
                ...
                (
                    "scheduled_date",
                    models.DateTimeField(help_text="When this task should be done"),
                ),
                (
                    "is_recurring",
                    models.BooleanField(
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, help_text="How often to repeat (in days)", null=True
                    ),
                ),
                (
                    "recurrence_end_date",
                ...
                (
                    "skipped",
                    models.BooleanField(
                        default=False, help_text="Was this task skipped?"
                    ),
                ),
                (
                    "skip_reason",
                    models.TextField(blank=True, help_text="Why task was skipped"),
                ),
                (
                    "skipped_at",
                    models.DateTimeField(
                        blank=True, help_text="When task was skipped", null=True
                    ),
                ),
                (
                    "notification_sent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.TextField(help_text="Log entry content/observations"),
                ),
                (
                    "temperature",
                    models.SmallIntegerField(
                ...
                (
                    "tags",
                    models.JSONField(
                        blank=True, default=list, help_text="Tags for categorizing logs"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        help_text="Plant photograph", upload_to="garden_plants/%Y/%m/"
                    ),
                ),
                (
                    "caption",
                ...
                (
                    "taken_date",
                    models.DateField(
                        auto_now_add=True, help_text="Date photo was taken"
                    ),
                ),
                (
                    "is_primary",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["owner", "-updated_at"], name="garden_cale_owner_i_7c376c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gardenbed",
            index=models.Index(
                fields=["owner", "is_active"], name="garden_cale_owner_i_05c963_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gardenbed",
            index=models.Index(
                fields=["hardiness_zone"], name="garden_cale_hardine_1ddfe9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plant",
            index=models.Index(
                fields=["garden_bed", "-planted_date"],
        ...
        migrations.AddIndex(
            model_name="plant",
            index=models.Index(
                fields=["garden_bed", "is_active"],
                name="garden_cale_garden__912f38_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="plant",
            index=models.Index(
                fields=["health_status"], name="garden_cale_health__88800e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="plant",
            index=models.Index(
                fields=["common_name"], name="garden_cale_common__548ee8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="harvest",
            index=models.Index(
                fields=["plant", "-harvest_date"], name="garden_cale_plant_i_642978_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="caretask",
            index=models.Index(
                fields=["plant", "scheduled_date"],
                name="garden_cale_plant_i_b4cbf0_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="caretask",
            index=models.Index(
                fields=["created_by", "completed", "skipped"],
                name="garden_cale_created_188cc1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="caretask",
            index=models.Index(
                fields=["task_type", "scheduled_date"],
                name="garden_cale_task_ty_9dc27a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="caretask",
            index=models.Index(
                fields=["scheduled_date", "completed"],
                name="garden_cale_schedul_d7c874_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="carelog",
            index=models.Index(
                fields=["plant", "-log_date"], name="garden_cale_plant_i_f8dc03_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="carelog",
            index=models.Index(
                fields=["user", "-log_date"], name="garden_cale_user_id_1030d7_idx"
            ),
        ),
    ]
