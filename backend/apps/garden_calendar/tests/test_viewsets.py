...
class GardenBedViewSetTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(
            username="gardener1", email="gardener1@test.com", password="testpass123"
        )
        self.user2 = User.objects.create_user(
            username="gardener2", email="gardener2@test.com", password="testpass123"
        )
    ...
    def test_create_garden_bed_unauthenticated(self):
        ...
        data = {"name": "My First Garden", "bed_type": "raised"}
    ...
    def test_list_garden_beds_only_own(self):
        ...
        GardenBed.objects.create(owner=self.user1, name="User 1 Bed", bed_type="raised")
        GardenBed.objects.create(owner=self.user2, name="User 2 Bed", bed_type="raised")
    ...
    def test_retrieve_other_user_bed_forbidden(self):
        ...
        bed = GardenBed.objects.create(
            owner=self.user2, name="User 2 Bed", bed_type="raised"
        )
    ...
    def test_update_garden_bed(self):
        ...
        bed = GardenBed.objects.create(
            owner=self.user1, name="Old Name", bed_type="raised"
        )

        data = {"name": "New Name", "bed_type": "raised", "soil_ph": "7.0"}

        response = self.client.put(
            f"/api/v1/calendar/api/garden-beds/{bed.uuid}/", data, format="json"
        )
    ...
    def test_partial_update_garden_bed(self):
        ...
        bed = GardenBed.objects.create(
            owner=self.user1, name="Original Name", bed_type="raised"
        )
    ...
    def test_delete_garden_bed(self):
        ...
        bed = GardenBed.objects.create(
            owner=self.user1, name="Bed to Delete", bed_type="raised"
        )
...
class PlantViewSetTest(TestCase):
    ...
    def test_list_plants_filtered_by_bed(self):
        ...
        other_bed = GardenBed.objects.create(
            owner=self.user, name="Other Bed", bed_type="container"
        )
        Plant.objects.create(
    ...
    def test_update_plant_health_status(self):
        ...
        response = self.client.put(
            f"/api/v1/calendar/api/plants/{plant.uuid}/", data, format="json"
        )
...
class CareTaskViewSetTest(TestCase):
    ...
    def test_mark_task_skip_action(self):
        ...
        response = self.client.post(
            f"/api/v1/calendar/api/care-tasks/{task.uuid}/skip/", data
        )
...
class HarvestViewSetTest(TestCase):
    ...
    def test_delete_harvest_record(self):
        ...
        response = self.client.delete(f"/api/v1/calendar/api/harvests/{harvest.id}/")
...
class CareLogViewSetTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_bed = GardenBed.objects.create(
            owner=self.other_user, name="Other Bed", bed_type="raised"
        )
    ...
    def test_create_care_log_unauthenticated(self):
        ...
        data = {"plant": str(self.plant.uuid), "notes": "Test log"}
    ...
    def test_list_care_logs_only_own_plants(self):
        ...
        CareLog.objects.create(plant=self.plant, user=self.user, notes="User log")
        CareLog.objects.create(
            plant=self.other_plant, user=self.other_user, notes="Other user log"
        )
    ...
    def test_retrieve_care_log_non_owner_denied(self):
        ...
        care_log = CareLog.objects.create(
            plant=self.plant, user=self.user, notes="User log"
        )
    ...
    def test_update_care_log(self):
        ...
        response = self.client.patch(
            f"/api/v1/calendar/api/care-logs/{care_log.uuid}/", data
        )
    ...
    def test_delete_care_log(self):
        ...
        care_log = CareLog.objects.create(
            plant=self.plant, user=self.user, notes="Log to delete"
        )
