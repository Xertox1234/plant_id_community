    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "common_names",
                    models.JSONField(default=list, help_text="List of common names"),
                ),
                ...
                (
                    "common_diseases",
                    models.JSONField(default=list, help_text="List of common diseases"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="garden_plants/"
                    ),
                ),
                (
                    "notes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pest_type",
                    models.CharField(
                        help_text="Type of pest or disease", max_length=200
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="garden",
            index=models.Index(
                fields=["user", "-updated_at"], name="garden_gard_user_id_adf17c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="garden",
            index=models.Index(
                fields=["visibility", "featured"], name="garden_gard_visibil_86823a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="carereminder",
            index=models.Index(
                fields=["user", "scheduled_date", "completed"],
                name="garden_care_user_id_e78502_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="carereminder",
            index=models.Index(
                fields=["notification_sent", "scheduled_date"],
                name="garden_care_notific_43ce67_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="journalentry",
            index=models.Index(
                fields=["user", "-date"], name="garden_jour_user_id_f5bfcd_idx"
            ),
        ),
    ]
