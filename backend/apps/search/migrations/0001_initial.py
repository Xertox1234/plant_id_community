...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result_type",
                    models.CharField(
                        help_text="Type of content that was clicked", max_length=20
                    ),
                ),
                (
                    "result_id",
                    models.CharField(
                        help_text="ID of the content that was clicked", max_length=100
                    ),
                ),
                (
                    "result_position",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["enable_alerts", "alert_frequency"],
                        name="search_save_enable__1d4820_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["query_text", "content_type"],
                name="search_sear_query_t_923311_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="searchquery",
            index=models.Index(
                fields=["user", "-created_at"], name="search_sear_user_id_544a0a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="searchquery",
            index=models.Index(
                ...
                name="search_sear_session_d5f438_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="searchquery",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["search_query", "result_type"],
                name="search_sear_search__94e25e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="searchresultclick",
            index=models.Index(
                ...
                name="search_sear_result__66c300_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="searchresultclick",
            index=models.Index(
                fields=["-clicked_at"], name="search_sear_clicked_06b5df_idx"
            ),
        ),
    ]
