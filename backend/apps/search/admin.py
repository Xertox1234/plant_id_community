...
from .models import SavedSearch, SearchQuery, SearchResultClick, UserSearchPreferences
...
class SearchQueryAdmin(admin.ModelAdmin):
    ...
    list_filter = ["content_type", "created_at", "results_count"]
...
class SavedSearchAdmin(admin.ModelAdmin):
    ...
    search_fields = ["name", "query_text", "user__username", "user__email"]
...
class SearchResultClickAdmin(admin.ModelAdmin):
    ...
    list_filter = ["result_type", "result_position", "result_page", "clicked_at"]
    search_fields = ["search_query__query_text", "result_id", "user__username"]
    readonly_fields = [
        "search_query",
        "result_type",
        "result_id",
